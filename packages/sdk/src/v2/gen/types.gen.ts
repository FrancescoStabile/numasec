...
/**
 * Server configuration for numasec serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: numasec.local)
   */
  mdnsDomain?: string
  /**
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://github.com/FrancescoStabile/numasec#commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://github.com/FrancescoStabile/numasec#agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
