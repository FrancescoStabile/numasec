import { Slug } from "@numasec/shared/util/slug"
...
export function plan(input: { slug: string; time: { created: number } }) {
  const base = Instance.project.vcs
    ? path.join(Instance.worktree, ".numasec", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@numasec/Session") {}
