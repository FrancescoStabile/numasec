...
export namespace Flag {
  ...
  export const NUMASEC_AUTO_HEAP_SNAPSHOT = truthy("NUMASEC_AUTO_HEAP_SNAPSHOT")
  ...
  export const NUMASEC_SHOW_TTFD = truthy("NUMASEC_SHOW_TTFD")
  ...
  export const NUMASEC_DISABLE_MOUSE = truthy("NUMASEC_DISABLE_MOUSE")
  export const NUMASEC_DISABLE_CLAUDE_CODE = truthy("NUMASEC_DISABLE_CLAUDE_CODE")
  export const NUMASEC_DISABLE_CLAUDE_CODE_PROMPT =
    NUMASEC_DISABLE_CLAUDE_CODE || truthy("NUMASEC_DISABLE_CLAUDE_CODE_PROMPT")
  export const NUMASEC_DISABLE_CLAUDE_CODE_SKILLS =
    NUMASEC_DISABLE_CLAUDE_CODE || truthy("NUMASEC_DISABLE_CLAUDE_CODE_SKILLS")
  export const NUMASEC_DISABLE_EXTERNAL_SKILLS =
    NUMASEC_DISABLE_CLAUDE_CODE_SKILLS || truthy("NUMASEC_DISABLE_EXTERNAL_SKILLS")
  ...
  export const NUMASEC_WORKSPACE_ID = process.env["NUMASEC_WORKSPACE_ID"]
  export const NUMASEC_EXPERIMENTAL_HTTPAPI = NUMASEC_EXPERIMENTAL || truthy("NUMASEC_EXPERIMENTAL_HTTPAPI")
...
// Dynamic getter for NUMASEC_PURE
// This must be evaluated at access time, not module load time,
// because the CLI can set this flag at runtime
Object.defineProperty(Flag, "NUMASEC_PURE", {
  get() {
    return truthy("NUMASEC_PURE")
  },
  enumerable: true,
  configurable: false,
})

// Dynamic getter for NUMASEC_PLUGIN_META_FILE
// This must be evaluated at access time, not module load time,
// because tests and external tooling may set this env var at runtime
Object.defineProperty(Flag, "NUMASEC_PLUGIN_META_FILE", {
  get() {
    return process.env["NUMASEC_PLUGIN_META_FILE"]
  },
  enumerable: true,
  configurable: false,
})
