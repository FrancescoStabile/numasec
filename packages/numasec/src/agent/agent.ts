...
import PROMPT_APPSEC from "./prompt/appsec.txt"
import PROMPT_OSINT from "./prompt/osint.txt"
import PROMPT_HACKING from "./prompt/hacking.txt"
...
export namespace Agent {
  ...
  export class Service extends Context.Service<Service, Interface>()("@numasec/Agent") {}
        ...
        Effect.fn("Agent.state")(function* (_ctx) {
            ...
            plan: {
              ...
              permission: Permission.merge(
                ...
                Permission.fromConfig({
                  ...
                  edit: {
                    "*": "deny",
                    [path.join(".numasec", "plans", "*.md")]: "allow",
          ...
          const list = Effect.fnUntraced(function* () {
            ...
            return pipe(
              ...
              values(),
              sortBy(
                [(x) => (cfg.default_agent ? x.name === cfg.default_agent : x.name === "security"), "desc"],
                [(x) => x.name, "asc"],
              ),
            )
          })
