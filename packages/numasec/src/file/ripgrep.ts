...
export namespace Ripgrep {
  ...
  export class Service extends Context.Service<Service, Interface>()("@numasec/Ripgrep") {}
  ...
  declare const NUMASEC_RIPGREP_WORKER_PATH: string

  function target(): Effect.Effect<string | URL, Error> {
    if (typeof NUMASEC_RIPGREP_WORKER_PATH !== "undefined") {
      return Effect.succeed(NUMASEC_RIPGREP_WORKER_PATH)
    }
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".numasec")) continue
