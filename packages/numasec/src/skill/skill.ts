...
const NUMASEC_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
...
const loadSkills = Effect.fnUntraced(function* (
  ...
  if (!Flag.NUMASEC_DISABLE_EXTERNAL_SKILLS) {
...
export class Service extends Context.Service<Service, Interface>()("@numasec/Skill") {}
