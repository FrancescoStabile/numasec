  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all Numasec sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific Numasec session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new Numasec session for interacting with AI assistants and managing conversations.",
      ...
      async (c) => {
        ...
        const session = await AppRuntime.runPromise(Session.Service.use((svc) => svc.create(body)))
