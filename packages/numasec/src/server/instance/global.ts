...
export const GlobalRoutes = lazy(() =>
  new Hono()
    .get(
      ...
      describeRoute({
        summary: "Get health",
        description: "Get health information about the Numasec server.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Subscribe to global events from the Numasec system using server-sent events.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the current global Numasec configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update global Numasec configuration settings and preferences.",
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose all Numasec instances, releasing all resources.",
    ...
    .post(
      "/upgrade",
      describeRoute({
        summary: "Upgrade numasec",
        description: "Upgrade numasec to the specified version or latest if not specified.",
