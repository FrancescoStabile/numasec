...
const image = "francescostabile/numasec"
...
if (!Script.preview) {
  ...
  const homebrewFormula = [
    ...
    `  desc "Terminal-native AI cyber operator harness."`,
    `  homepage "https://github.com/FrancescoStabile/numasec"`,
    ...
    `      url "https://github.com/FrancescoStabile/numasec/releases/download/v${Script.version}/numasec-darwin-x64.zip"`,
    `      sha256 "${macX64Sha}"`,
    "",
    "      def install",
    '        bin.install "numasec"',
    ...
    "    end",
    "    if Hardware::CPU.arm?",
    `      url "https://github.com/FrancescoStabile/numasec/releases/download/v${Script.version}/numasec-darwin-arm64.zip"`,
    `      sha256 "${macArm64Sha}"`,
    "",
    "      def install",
    '        bin.install "numasec"',
    ...
    `      url "https://github.com/FrancescoStabile/numasec/releases/download/v${Script.version}/numasec-linux-x64.tar.gz"`,
    `      sha256 "${x64Sha}"`,
    "      def install",
    '        bin.install "numasec"',
    "      end",
    ...
    `      url "https://github.com/FrancescoStabile/numasec/releases/download/v${Script.version}/numasec-linux-arm64.tar.gz"`,
    `      sha256 "${arm64Sha}"`,
    "      def install",
    '        bin.install "numasec"',
    "      end",
  ...
  const tap = `https://x-access-token:${token}@github.com/FrancescoStabile/homebrew-numasec.git`
