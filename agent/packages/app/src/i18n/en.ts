export const dict = {
  ...
  "dialog.provider.numasec.note": "Curated models including Claude, GPT, Gemini and more",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Numasec",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Numasec.",
  ...
  "provider.connect.numasecZen.visit.link": "numasec.ai/zen",
  "provider.connect.numasecZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Numasec.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Numasec.",
  ...
  "prompt.example.1": "Scan http://localhost:3000 for vulnerabilities",
  "prompt.example.2": "Find SQL injection in the login endpoint",
  "prompt.example.3": "Test for XSS in all input fields",
  "prompt.example.4": "Check if JWT tokens are properly validated",
  "prompt.example.5": "Run a full pentest and generate a report",
  "prompt.example.6": "Look for hardcoded secrets in JavaScript files",
  "prompt.example.7": "Test authentication for default credentials",
  "prompt.example.8": "Check CORS configuration for misconfigurations",
  "prompt.example.9": "Find IDOR vulnerabilities in the API",
  "prompt.example.10": "Test for SSRF and cloud metadata exposure",
  "prompt.example.11": "Check HTTP security headers",
  "prompt.example.12": "Find path traversal and LFI vulnerabilities",
  "prompt.example.13": "Test for command injection",
  "prompt.example.14": "Enumerate all API endpoints",
  "prompt.example.15": "Check for GraphQL introspection exposure",
  "prompt.example.16": "Test OAuth flow for misconfigurations",
  "prompt.example.17": "Find exposed .env files and sensitive paths",
  "prompt.example.18": "Test for SSTI in template engines",
  "prompt.example.19": "Check for XXE in XML endpoints",
  "prompt.example.20": "Map the attack surface of this application",
  "prompt.example.21": "Test for CSRF on state-changing endpoints",
  "prompt.example.22": "Check if rate limiting is enforced on login",
  "prompt.example.23": "Find broken access controls",
  "prompt.example.24": "Scan for known CVEs in detected dependencies",
  "prompt.example.25": "Chain findings into a full attack narrative",
  ...
  "dialog.plugins.empty": "Plugins configured in numasec.json",
  ...
  "dialog.server.description": "Switch which Numasec server this app connects to.",
  ...
  "toast.update.description": "A new version of Numasec ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Numasec team",
  ...
  "error.chain.checkConfig": "Check your config (numasec.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Numasec does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Numasec includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Numasec server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Numasec",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Numasec looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Numasec follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Numasec is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Numasec launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Numasec.",
