/**
 * OWASP Top 10 (2021) mapping from CWE IDs.
 */

export const CWE_OWASP_MAP: Record<string, string> = {
...
/** Map CWE ID to OWASP Top 10 2021 category. Returns empty string if unmapped. */
export function getOwaspCategory(cweId: string): string {
  return CWE_OWASP_MAP[cweId] ?? ""
}

/** All 10 OWASP categories for coverage tracking. */
